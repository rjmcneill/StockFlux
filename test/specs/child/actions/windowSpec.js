...
describe('child/actions/window', () => {
    it('should create an action for minimize', () => {
        const expectedAction = { windowId: 0, type: ACTION_TYPES.MINIMIZE };
